...
%    \begin{definition}[Hyperplane \cite{loeh}]
%        For a CAT(0) cube complex $X$, a \textit{hyperplane} is a set ${ H_{L}, H_{R}}$, for $H_{L}, H_{R} \in H$, where $H$ is the set of halfspaces in $X$.
%    \end{definition}
